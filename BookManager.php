...
<body>
    ...
    <table border="1" cellspacing="1" style="text-align: center; margin-top: 5%;">
        <tr>
            ...
            <td colspan="2"><a href="AddUpdateBook.php?userId=<?php echo $id ?>">Thêm</a></td>
        </tr>
        <?php
        $books = findAllBook();
        ...
        ?>
            <tr>
                ...
                <td><?php
                    $date = date_create($b->ngaycapnhat);
                    echo date_format($date, "d/m/Y");
                    ?></td>

                <td style="width:5% "><a href="AddUpdateBook.php?id=<?php echo $b->id ?>&userId=<?php echo $id?>">Sửa</a></td>
                <td style="width:5% "><a href="DeleteBook.php?id=<?php echo $b->id ?>">Xóa</a></td>
            </tr>
        <?php
        }
        ?>
